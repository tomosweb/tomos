...
現在のバージョンは `v0.1.0-alpha.18` です。限定テスト用の初期開発版であり、正式リリース版ではありません。

> **v0.1.0-alpha.17から更新する方へ**
>
> v0.1.0-alpha.18への更新は2段階です。
>
> 1. Tomos Updateで `tomos-update-0.1.0-alpha.18.zip` を適用します。
> 2. 更新後に `/post/update-finalize/` を開き、「Updater更新を反映する」を実行します。
>
> **2まで完了して、v0.1.0-alpha.18への更新は完了です。** 1の完了後はVERSIONがalpha.18と表示されますが、Updater本体はまだ反映待ちです。

詳しくは [v0.1.0-alpha.18の更新案内](docs/releases/v0.1.0-alpha.18.md) を確認してください。
