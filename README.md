...
現在のバージョンは `v0.6.1` です。Tomosは現在0.x開発系列であり、1.0の安定版ではありません。
...
詳しくは [v0.6.1の更新案内](docs/releases/v0.6.1.md) を確認してください。過去のalpha/betaからの移行手順は[既存環境の更新手順](docs/install/update.md)に履歴として掲載しています。
