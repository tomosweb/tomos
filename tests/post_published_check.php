...
$multiWordSearch = $published->list('新しい 京都', '', 1, 50);
assertSame(['new.md'], array_column($multiWordSearch['items'], 'path'), 'multi-word search must match terms across searchable fields');
$multiWordMiss = $published->list('新しい 東京', '', 1, 50);
assertSame([], array_column($multiWordMiss['items'], 'path'), 'multi-word search must require every term');
$caseInsensitiveSearch = $published->list('old article', '', 1, 50);
assertSame(['notes/old.md'], array_column($caseInsensitiveSearch['items'], 'path'), 'multi-word search must remain case-insensitive');
