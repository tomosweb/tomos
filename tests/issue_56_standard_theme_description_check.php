...
foreach ($themes as $theme) {
    ...
    assertIssue56(strpos($layoutTemplate, '{{{ page.seo_head_html }}}') !== false, $theme . ' SEO head placeholder was removed');
    assertIssue56(strpos($layoutTemplate, 'name="description" content="{{ page.description }}"') === false, $theme . ' legacy meta description was not centralized');
    assertIssue56(strpos($layoutTemplate, 'property="og:description" content="{{ page.description }}"') === false, $theme . ' legacy OGP description was not centralized');
}
