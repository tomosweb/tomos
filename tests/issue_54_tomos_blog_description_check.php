...
$otherThemeTemplate = file_get_contents($root . '/themes/tomos-note/templates/page.html');
...
assertIssue54(is_string($otherThemeTemplate), 'other theme page template could not be read');
...
assertIssue54(strpos($otherThemeTemplate, '<p class="page-description">{{ page.description }}</p>') !== false, 'other theme was changed');
