...
function renderTomosDailyMessage(): void
{
    ...
    echo '<path d="M16 18v-4" fill="none" stroke="var(--tomos-text)" stroke-linecap="round" stroke-width="1"></path>';
    echo '<path d="M10 18h12v15c0 1-1 2-2 2h-8c-1 0-2-1-2-2V18Z" fill="#f0dfc6" stroke="var(--tomos-text)" stroke-opacity=".6" stroke-width="1"></path>';
    echo '<ellipse cx="16" cy="18" rx="6" ry="2" fill="#f0dfc6" stroke="var(--tomos-text)" stroke-opacity=".6" stroke-width="1"></ellipse>';
    echo '</svg>';
    echo '</div>';
