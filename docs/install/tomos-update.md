...
alpha.6への移行後は、alpha.7以降の署名済みUpdate ZIPをこの画面で確認できます。alpha.10のUpdate ZIPは、現在のバージョンが`0.1.0-alpha.9`以上の場合に適用できます。
...
alpha.10では、通常Update完了後にUpdater本体の明示反映が必要です。
