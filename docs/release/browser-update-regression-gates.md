...
毎回のReleaseで必須なのは、現在supportするsource versionからtarget versionへの実artifact更新です。v0.7.1では、v0.7.0実Release baselineからv0.7.1への更新、署名・SHA-256・manifest、runtime配置、保護データ保持、rollback、実サイト起動、公開URLからの再取得を必須とします。
